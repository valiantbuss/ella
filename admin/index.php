<?php session_start(); if(isset($_SESSION['sysId'])){header("Location:dashboard/");} ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
...
<div id="loginContainerContent">
            ...
            <div>
                <div align="center" class="brand_logo_container"><img src="../assets/images/login.png" alt="Logo" class="brand_logo" /></div>
